    ...
    <fieldset class="com-finder__search word mb-3">
        ...
        <div class="form-inline">
            ...
            <div class="input-group">
                <input type="text" name="q" id="q" class="js-finder-search-query form-control" value="<?php //echo $this->escape($this->query->input); ?>" placeholder="<?php //echo Text::_('COM_FINDER_SEARCH_TERMS'); ?>">
                <button type="submit" class="btn btn-primary">
                    <span class="icon-search icon-white" aria-hidden="true"></span>
                    <?php //echo Text::_('JSEARCH_FILTER_SUBMIT'); ?>
                </button>
                <?php //if ($this->params->get('show_advanced', 0)) : ?>
