...
class GantryFeatureStyleDeclaration extends GantryFeature {
	...
	$gantry->addLess('jf_global.less', 'master.css', 8, $lessVariables);
	
	// START VARIABLES - JF JOOMLA CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////
		$jf_custom_style_lessVariables = array (
			'jf_colors_bg'    					=> $gantry->get('jf_colors_bg',					'#f3f3f3'),
			'jf_colors_header'    				=> $gantry->get('jf_colors_header',				'#060C17'),
			'jf_colors_footer'    				=> $gantry->get('jf_colors_footer',				'#060C17'),
			'jf_colors_footer_Mborder'    		=> $gantry->get('jf_colors_footer_Mborder',		'#CC0000'),
			'jf_colors_link'    				=> $gantry->get('jf_colors_link',				'#CC0000'),
			'jf_colors_SideModTitle' 	   		=> $gantry->get('jf_colors_SideModTitle',		'#060C17'),
			'jf_colors_main'    				=> $gantry->get('jf_colors_main',				'#060C17')
		);
		$gantry->addLess('jf_custom_style.less', 'jf_custom_style.css', 8, $jf_custom_style_lessVariables);
	// START VARIABLES - JF KUNENA CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////
		if ($gantry->get('jf_ku_colors_override')) {
			$jf_custom_ku_style_lessVariables = array (
				'jf_ku_UC_MainColor'  			=> $gantry->get('jf_ku_UC_MainColor',			'#060C17'),
				'jf_ku_UC_MainColor2'  			=> $gantry->get('jf_ku_UC_MainColor2',			'#cc0000'),
				'jf_ku_UC_HeaderColor1'  		=> $gantry->get('jf_ku_UC_HeaderColor1',		'#cc0000'),
				'jf_ku_UC_HeaderColor2'  		=> $gantry->get('jf_ku_UC_HeaderColor2',		'#060C17'),
				'jf_ku_UC_MenuColor'  			=> $gantry->get('jf_ku_UC_MenuColor',			'#cc0000'),
				'jf_ku_UC_MenuBorderColor'  	=> $gantry->get('jf_ku_UC_MenuBorderColor',		'#060C17')
			);
			$gantry->addLess('jf_custom_kunena_style.less', 'jf_custom_kunena_style.css', 8, $jf_custom_ku_style_lessVariables);
		}
	//   END VARIABLES - JF KUNENA CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////

	// START VARIABLES - JF JOMSOCIAL CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////
		if ($gantry->get('jf_js_colors_override')) {
			$jf_custom_js_style_lessVariables = array (
				'jf_js_UC_Main'  				=> $gantry->get('jf_js_UC_Main',				'#060C17'),
				'jf_js_UC_RedColor'  			=> $gantry->get('jf_js_UC_RedColor',			'#cc0000'),
				'jf_js_UC_ModTitleColor'  		=> $gantry->get('jf_js_UC_ModTitleColor',		'#060C17'),
				'jf_js_UC_MenuColor'  			=> $gantry->get('jf_js_UC_MenuColor',			'#cc0000'),
				'jf_js_UC_MenuBorderColor'  	=> $gantry->get('jf_js_UC_MenuBorderColor',		'#060C17')
			);
			$gantry->addLess('jf_custom_jomsocial_style.less', 'jf_custom_jomsocial_style.css', 8, $jf_custom_js_style_lessVariables);
		}
	//   END VARIABLES - JF JOMSOCIAL CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////
