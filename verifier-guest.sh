...
cp /home/ubuntu/openquake/taxonomy/test/config/moon_config.py.tmpl /home/ubuntu/openquake/taxonomy/test/config/moon_config.py
git clone -b "$branch_id" --depth=1  $GEM_GIT_REPO/oq-moon.git || git clone --depth=1 $GEM_GIT_REPO/oq-moon.git

export DISPLAY=:1
export PYTHONPATH=oq-moon:/home/ubuntu/:/home/ubuntu/openquake/taxonomy/test/config
