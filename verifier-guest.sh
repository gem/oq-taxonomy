...
exec_test () {    
    ...
    python3 -m openquake.moon.nose_runner --failurecatcher dev -s -v --with-xunit --xunit-file=xunit-platform-dev.xml $HOME/$GEM_GIT_PACKAGE/openquake/taxonomy/test || true
    # sleep 40000 || true
}
