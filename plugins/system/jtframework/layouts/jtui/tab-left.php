...
extract($displayData);
?>
<div class="jtui-tab tab-left">
	<div class="jt-grid">
		<div class="jt-width-medium-1-4">
			<ul class="jt-tab jt-tab-left" data-jt-switcher="{connect:'#<?php echo $tabId; ?>'}">
				<?php echo $tabTitle; ?>
			</ul>
		</div>
		<div class="jt-width-medium-3-4">
